...
public class OI {
	...
	public JoystickButton dropBalls;
    ...
    public OI() {
        ...
        shootBallOut = new JoystickButton(joystick1, 8);
        shootBallOut.whenPressed(new BallShoot());

        
        dropBalls = new JoystickButton(joystick1, 1);
        dropBalls.whenPressed(new BallDrop());
        dropBalls.whenReleased(new BallStop());
